...
/*
        ...
        $maxpagesshown, // pages to be shown at pagination division
        $totalrecords, //The total number of records to be paginated
        $recordsperpage, // Total number of records contained in a page
        $recordoffset, //Number of multiple records to offset out. If not set, it's determined to be zero
        $maxpagesshown = 5, //Defaultly 5, if this property is not define outside this class
        $params = "" //category parameter at urlencode which must be string
*/
////////////////////////////////////////////////////////////////////
class PageNavigator{
    //data members
