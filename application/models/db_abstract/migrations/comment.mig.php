...
class Comment{
	...
	// 4 	comment_text 	text 	
	// 5 	commenter_user_id 	int(11)
	// 6 	date_added 	timestamp  	CURRENT_TIMESTAMP 	

	private static $table = "comments"; //Db Table
    protected static $db_fields=array('id', 'item_id', 'item_type', 'comment_text', 'commenter_user_id', 'date_added');
