<?php
/**
 * <h1>Akaddit v2 DepartmentList Class</h1>
...
class DepartmentList{
    ...
    //2	department_name	varchar(100)

    private static $table = "departments_list"; //Db Table
    protected static $db_fields=array('id', 'department_name');
